...
For the current Synology production stack, use `/volume1/joinerflow/...` paths from the Current Infrastructure Stack section above, not the generic `/opt/joinerflow` Linux examples.
