...
const defaultClientModeContext = {
  clientMode: false,
  setClientMode: () => {},
  toggleClientMode: () => {},
};

const ClientModeContext = createContext(defaultClientModeContext);
...
export function useClientMode() {
  return useContext(ClientModeContext) || defaultClientModeContext;
}
