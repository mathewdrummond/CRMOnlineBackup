...
import { PO_STATUSES, formatCurrency, formatDate, getStageConfig } from "../lib/helpers";
    ...
    <div className="p-4 lg:p-6 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          {["sent","part_received"].includes(po.status) && <Button size="sm" onClick={() => crmApi.entities.PurchaseOrder.update(id, { status: "received", received_date: new Date().toISOString().split("T")[0] }).then(loadData)}><CheckCircle className="w-3.5 h-3.5 mr-1" />Mark Received</Button>}
