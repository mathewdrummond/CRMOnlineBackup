...
public_origin="${JOINERFLOW_PUBLIC_ORIGIN:-https://joinerflow.local}"
...
upsert_default_env "ALLOWED_HOSTS" "${public_host},${clock_host}"
upsert_default_env "CORS_ORIGIN" "${public_origin},${clock_origin}"
...
upsert_default_env "OLLAMA_BASE_URL" "${OLLAMA_BASE_URL:-http://ollama:11434}"
upsert_default_env "OLLAMA_PRIMARY_MODEL" "${OLLAMA_PRIMARY_MODEL:-qwen2.5:3b-instruct-q4_K_M}"
upsert_default_env "OLLAMA_FAST_MODEL" "${OLLAMA_FAST_MODEL:-gemma3:1b}"
upsert_default_env "OLLAMA_EMBED_MODEL" "${OLLAMA_EMBED_MODEL:-nomic-embed-text}"
upsert_default_env "QDRANT_URL" "${QDRANT_URL:-http://qdrant:6333}"
